...
#define BOARD_NAME "Maixduino"

/* The UART to use for debug messages. */
#define BOARD_DEBUG_UART_TYPE kSerialPort_Uart //?
#define BOARD_DEBUG_UART_BASEADDR UARTHS_BASE_ADDR
#define BOARD_DEBUG_UART_INSTANCE 1U //?

#define BOARD_DEBUG_UART_CLK_FREQ sysctl_clock_get_freq(SYSCTL_CLOCK_CPU)

#define BOARD_UART_IRQ IRQN_UARTHS_INTERRUPT
